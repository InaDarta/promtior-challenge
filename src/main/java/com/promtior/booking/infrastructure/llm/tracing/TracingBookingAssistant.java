package com.promtior.booking.infrastructure.llm.tracing;
...
import com.promtior.booking.infrastructure.llm.config.LangfuseProperties;
 ...
 * com.promtior.booking.infrastructure.rest.controller.ChatController}), así que agrupar por ese
 * valor ya agrupa por sesión y por usuario a la vez.
 */
public class TracingBookingAssistant implements BookingAssistant {
  ...
  public TracingBookingAssistant(
