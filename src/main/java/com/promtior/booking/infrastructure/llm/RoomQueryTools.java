...
class RoomQueryTools {
  ...
  List<Room> listAvailableRooms(
      @P("Inicio del rango, formato ISO-8601 (ej. 2026-08-31T10:00:00)") LocalDateTime start,
      @P("Fin del rango, formato ISO-8601 (ej. 2026-08-31T11:00:00)") LocalDateTime end,
  ...
  AvailabilitySummary getRoomSchedule(
      ...
      @P("Inicio del rango, formato ISO-8601 (ej. 2026-08-31T10:00:00)") LocalDateTime start,
      @P("Fin del rango, formato ISO-8601 (ej. 2026-08-31T11:00:00)") LocalDateTime end) {
    return AvailabilitySummary.from(getRoomSchedule.execute(room, BookingRanges.of(start, end)));
  }
}
