 ...
 */
public final class BookingRanges {

  private BookingRanges() {}

  public static BookingRange of(LocalDateTime start, LocalDateTime end) {
    return BookingRange.between(new TimeSlot(start), new TimeSlot(end.minusMinutes(30)));
  }

  public static QueryRange query(LocalDateTime start, LocalDateTime end) {
